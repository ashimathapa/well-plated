...
const loginBtn = document.querySelector(".btn--show-modal[href='#login']");

const signUpModal = document.getElementById("sign-up");
const signUpBtn = document.querySelector(".btn--show-modal[href='#sign-up']");
...
// const fetchRecipes = () => {
//   const data = fetch(`http://127.0.0.1:5500/momo.html`);
// }
// viewRecipe.addEventListener('click',(e)=>{
//   e.preventDefault()
//   fetchRecipes();
